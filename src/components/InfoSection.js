...
const Container = styled.div`
    ...
    display: grid;
    grid-template-column: 1fr 1fr;      // Side by side
...
const ColumnLeft = styled.div`
    ...
    line-height: 1.4;
    padding: 1 rem 2rem;
    order: ${({ reverse }) => ( reverse ? '2' : '1' )};  // Reverse the order of the grid  
...
const ColumnRight = styled.div`
  padding: 1rem 2rem;
  order: ${({ reverse }) => reverse ? "1" : "2"}; // Reverse the order of the grid
  display: flex;
  justify-content: center;
  align-items: center;
